'use client'
import { DotsNine, ListBullets, Plus } from '@phosphor-icons/react'
        ...
        <div className='flex justify-center'> 
            <div className='bg-color-secondary'>
                ...
                <div className='h-[60px] w-[66rem] rounded-xl mt-4 flex items-center justify-between'>
                    ...
                    <button type='button' onClick={handleAddCar} className='flex justify-center items-center gap-2 px-4 py-3 text-color-white bg-color-primary rounded-lg font-semibold '>
                        ADD CAR
                        <Plus size={20} />
                    </button>
                </div>
