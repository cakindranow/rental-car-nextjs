...
const ListOrderAdminComponent = ({ token }: Props) => {
        ...
        <div className='bg-color-secondary w-[80%] bg-color'>
            ...
            <Table className='mt-10' aria-label="Example static collection table">
                <TableHeader>
                    ...
                    <TableColumn><p>STATUS</p></TableColumn>
                ...
                <TableBody className=''>
                    {data?.map((order: OrderResponseInterface, idx) => (
                        <TableRow className='' key={idx}>
                            ...
                            <TableCell>{order.requested_name}</TableCell>
                            ...
                            <TableCell className='flex gap-2'>
                                {order.status_name == "On Process" ? <Button onPress={()=>{
                                    handleAccept(order.id)
                                }} className='border-color-green bg-color-white border-2 border-opacity-50  bg-opacity-25 font-bold text-color-green rounded-full py-2 px-2 p-2'>Accept</Button> : <></>}
                                
                                {order.status_name == "On Process" ? <Button  onPress={()=>{
                                    handleReject(order.id)
                                }} className='bg-color-red bg-opacity-25 font-bold text-color-red rounded-full py-2 px-2 p-2'>Reject</Button> : <></>}
                            </TableCell>
...
export default ListOrderAdminComponent