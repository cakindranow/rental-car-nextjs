        ...
        <div className='flex justify-center'>
            <div className='bg-color-white w-1/2 mt-10 p-10 rounded-2xl pb-10'>
                ...
                <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-10">
                    ...
                    <button type="submit" className="text-white bg-color-blue-dark text-color-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </form>
