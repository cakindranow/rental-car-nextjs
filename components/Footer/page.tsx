            ...
            <div className="flex flex-col">
                <div className="flex  mx-auto gap-28 mt-10">
                    <div className="text-color-white  flex flex-col items-center">
                        ...
                        <p className="font-light">Across West & East India</p>
                    </div>
                    <div className="text-color-white  flex flex-col items-center">
                        <Wallet size={32} />
                ...
                <div className="flex mx-auto gap-20 mt-5">
                    ...
                    <div className="text-color-white w-[250px]">
                        <p>HOT CATEGORIES</p>
                        <p className="opacity-90 font-light mt-10 flex gap-1">Fruits & Categories </p>
                        <p className="opacity-90 font-light mt-2 flex gap-1">Dairy Products</p>
                        <p className="opacity-90 font-light mt-2 flex gap-1">Package Foods</p>
                        <p className="opacity-90 font-light mt-2 flex gap-1">Beverage</p>
                        <p className="opacity-90 font-light mt-2 flex gap-1">Health & Wellness</p>
